...
import { AlertTriangle, User, Lock, Trash2, LogOut, Camera, Edit3, Save, X } from "lucide-react";
            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-3 mb-4 p-3 bg-red-50 border border-red-200 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-600 mt-1">All your data will be permanently deleted</p>
                </div>
              </div>
              <div className="flex justify-center">
                <Button 
                  ...
                  className="bg-red-600 hover:bg-red-700 px-6 py-2 rounded-lg font-medium transition-all duration-300"
                >
